...
int idRadice = 1;
	...
	/**
	 * Metodo che restituisce vero se una articolo ï¿½ presente in un offerta con lo
	 * stato indicato
	 * 
	 * @param idArticolo
	 * @param stato
	...
	/**
	 * Metodo che restituisce il baratto in cui ï¿½ coinvolta l' offerta
	 * 
	 * @param idOfferta
	 * @return baratto
	 * @throws SQLException
	...
	/**
	 * Metodo per controllare se un nome è già presente nel db
	 * 
	 * @param name
	 * @return bool
	 * @throws SQLException
