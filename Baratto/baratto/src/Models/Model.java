...
public class Model {
	...
	public boolean controlloNomeUtente(String name) throws SQLException {
		if (db != null) { // Verifica se l'oggetto db è stato inizializzato
			return db.controlloNomeUtente(name);
		} else {
			throw new IllegalStateException("L'oggetto db non è stato inizializzato correttamente");
		}
	}
...
//metodo per controllare se nome già presente
	...
	// Metodo per controllare se un orario è all'inteno di un intervallo
